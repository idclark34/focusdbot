...
echo "3. Grant Accessibility permission when prompted (for AI activity tracking)"
echo "4. Look for the robot in your menu bar!"
echo ""
echo "🤖 AI Features Setup (Optional):"
echo "To enable AI-powered session summaries, set up your environment:"
echo "export FOCUSD_PROXY_URL=\"https://your-proxy.workers.dev\""
echo "echo 'export FOCUSD_PROXY_URL=\"https://your-proxy.workers.dev\"' >> ~/.zshrc"
echo ""
echo "🎉 Enjoy your new focus companion with AI insights!"